package com.gdou.car.common.exception;
...
//        super(errorCode);
//        this.errorCode= UserResponseCodeEnum.SYS_PARAM_NOT_RIGHT.getCode();
//        this.errorMessage=UserResponseCodeEnum.SYS_PARAM_NOT_RIGHT.getMsg();
//    }
